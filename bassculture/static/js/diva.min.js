...
(function(b){b.updateHashParam=function(f,e){var c=b.getHashParam(f),a=window.location.hash;if(c!==e)if("string"==typeof c){var h=0<a.indexOf("&"+f+"=")?a.indexOf("&"+f+"="):a.indexOf("#"+f+"="),c=h+f.length+2+c.length,g=0===h?"#":"&";window.location.replace(a.substring(0,h)+g+f+"="+e+a.substring(c))}else 0===a.length?window.location.replace("#"+f+"="+e):window.location.replace(a+"&"+f+"="+e)}})(jQuery);
...
e.scrollTop+b.velocityY,0<Math.abs(b.velocityY)&&(b.velocityY=b.decelerate?c(b.velocityY,b.slowdown):b.velocityY)):b.velocityY=0;h.call(a,b,b.deceleratingClass);"function"===typeof b.moved&&b.moved.call(a,b);0<Math.abs(b.velocity)||0<Math.abs(b.velocityY)?window.requestAnimationFrame(function(){k(a,b)}):g(a,b)},l=function(a,c){var e=b.kinetic.callMethods[a],f=Array.prototype.slice.call(arguments);e&&this.each(function(){var a=f.slice(1),c=b(this).data("kinetic-settings");a.unshift(c);e.apply(this,
a)})},u=function(a,c){b.support.touch?a.bind("touchstart",c.events.touchStart).bind("touchend",c.events.inputEnd).bind("touchmove",c.events.touchMove):a.mousedown(c.events.inputDown).mouseup(c.events.inputEnd).mousemove(c.events.inputMove);a.click(c.events.inputClick).scroll(c.events.scroll).bind("selectstart",e).bind("dragstart",c.events.dragStart)},r=function(c){this.addClass("kinetic-active").each(function(){var e=this,g=b(this);if(!g.data("kinetic-settings")){var m=b.extend({},f,c),l,r=!1,x,y=
!1,z=!1,A=1E3/m.throttleFPS,I,G;m.velocity=0;m.velocityY=0;var K=function(){z=x=l=!1};b(document).mouseup(K).click(K);var p=function(){m.velocity=a(r-l,m.maxvelocity);m.velocityY=a(y-x,m.maxvelocity)},w=function(a){return b.isFunction(m.filterTarget)?!1!==m.filterTarget.call(e,a):!0},F=function(a,c){if(!I||new Date>new Date(I.getTime()+A))I=new Date,z&&(l||x)&&(G&&(b(G).blur(),G=null,g.focus()),m.decelerate=!1,m.velocity=m.velocityY=0,g[0].scrollLeft=m.scrollLeft=m.x?g[0].scrollLeft-(a-l):g[0].scrollLeft,
g[0].scrollTop=m.scrollTop=m.y?g[0].scrollTop-(c-x):g[0].scrollTop,r=l,y=x,l=a,x=c,p(),h.call(g,m,m.movingClass),"function"===typeof m.moved&&m.moved.call(g,m))};m.events={touchStart:function(a){var b;if(w(a.target)){b=a.originalEvent.touches[0];var c=b.clientX;b=b.clientY;z=!0;m.velocity=r=0;m.velocityY=y=0;l=c;x=b;a.stopPropagation()}},touchMove:function(a){var b;z&&(b=a.originalEvent.touches[0],F(b.clientX,b.clientY),a.preventDefault&&a.preventDefault())},inputDown:function(a){if(w(a.target)){var b=
a.clientX,c=a.clientY;z=!0;m.velocity=r=0;m.velocityY=y=0;l=b;x=c;G=a.target;"IMG"===a.target.nodeName&&a.preventDefault();a.stopPropagation()}},inputEnd:function(a){l&&r&&!1===m.decelerate&&(m.decelerate=!0,p(),l=r=z=!1,k(g,m));G=null;a.preventDefault&&a.preventDefault()},inputMove:function(a){z&&(F(a.clientX,a.clientY),a.preventDefault&&a.preventDefault())},scroll:function(a){"function"===typeof m.moved&&m.moved.call(g,m);a.preventDefault&&a.preventDefault()},inputClick:function(a){if(0<Math.abs(m.velocity))return a.preventDefault(),
!1},dragStart:function(a){if(G)return!1}};u(g,m);g.data("kinetic-settings",m).css("cursor",m.cursor);m.triggerHardware&&g.css({"-webkit-transform":"translate3d(0,0,0)","-webkit-perspective":"1000","-webkit-backface-visibility":"hidden"})}})};b.kinetic={settingsKey:"kinetic-settings",callMethods:{start:function(a,c){var e=b(this);if(a=b.extend(a,c))a.decelerate=!1,k(e,a)},end:function(a,c){b(this);a&&(a.decelerate=!0)},stop:function(a,c){var e=b(this);g(e,a)},detach:function(a,c){var f=b(this);b.support.touch?
f.unbind("touchstart",a.events.touchStart).unbind("touchend",a.events.inputEnd).unbind("touchmove",a.events.touchMove):f.unbind("mousedown",a.events.inputDown).unbind("mouseup",a.events.inputEnd).unbind("mousemove",a.events.inputMove).unbind("scroll",a.events.scroll);f.unbind("click",a.events.inputClick).unbind("selectstart",e);f.unbind("dragstart",a.events.dragStart);f.removeClass("kinetic-active").css("cursor","")},attach:function(a,c){var e=b(this);u(e,a);e.addClass("kinetic-active").css("cursor",
"move")}}};b.fn.kinetic=function(a){"string"===typeof a?l.apply(this,arguments):r.call(this,a);return this}})(window.jQuery||window.Zepto);
...
pageTimeouts:[],pageTools:"",panelHeight:0,panelWidth:0,plugins:[],previousLeftScroll:0,previousTopScroll:0,realMaxZoom:-1,resizeTimer:-1,rowHeight:0,scaleWait:!1,scrollbarWidth:0,selector:"",singleClick:!1,singleTap:!1,throbberTimeoutID:-1,toolbar:null,totalHeights:[],totalHeight:0,totalWidths:[],totalWidth:0,verticalOffset:0,verticalPadding:0});var f=this,g=function(a){var b=!0;return function(a){var d,c,e;if("function"===typeof a){d=[];c=1;for(e=arguments.length;c<e;c++)d.push(arguments[c]);b&&
(console.warn('The use of callback functions is deprecated. Use diva.Events.subscribe("Event", function) instead.'),b=!1);a.apply(f,d);return!0}return!1}}(),k=function(d,b){return a.pages[d].d[a.zoomLevel][b]},l=function(d){var b,c=a.numPages;for(b=0;b<c;b++)if(a.pages[b].f===d)return b;return-1},u=function(d,c){var e=b("#"+a.ID+"outer").scrollLeft()-a.viewportMargin,f=e+a.panelWidth+2*a.viewportMargin;return d>=e&&d<=f||d<=e&&c>=f||c>=e&&c<=f},r=function(d,c){var e=b("#"+a.ID+"outer").scrollTop()-
a.viewportMargin,f=e+a.panelHeight+2*a.viewportMargin;return d>=e&&d<=f||d<=e&&c>=f||c>=e&&c<=f},q=function(d){return 0<=d&&d<a.numPages},s=function(d){var b=a.pageTopOffsets[d],c=b+k(d,"h")+a.verticalPadding,e=a.pageLeftOffsets[d];d=e+k(d,"w")+a.horizontalPadding;return r(b,c)&&u(e,d)},v=function(d){return!!document.getElementById(a.ID+"page-"+d)},m=function(d){if(!v(d)||!a.allTilesLoaded[d]){var b=a.pages[d].f,c=k(d,"w"),e=k(d,"h"),p=a.pageTopOffsets[d]+a.verticalPadding,w=a.pageLeftOffsets[d]+
a.horizontalPadding,T=a.selector+"page-"+d,l;if(!v(d)){var q=document.getElementById(a.ID+"inner"),n=document.createElement("div");n.id=a.ID+"page-"+d;n.classList.add("diva-document-page");n.setAttribute("data-index",d);n.setAttribute("data-filename",b);a.enableImageTitles&&(n.title="Image "+(d+1));n.innerHTML=a.pageTools;n.style.width=c+"px";n.style.height=e+"px";a.verticallyOriented?(n.style.top=p+"px",n.classList.add("diva-page-vertical")):(n.style.left=w+"px",n.classList.add("diva-page-horizontal"));
q.appendChild(n);g(a.onPageLoad,d,b,T);diva.Events.publish("PageWillLoad",[d,b,T],f);for(l in a.plugins)g(a.plugins[l].onPageLoad,d,b,T)}a.pageTimeouts.push(setTimeout(function(d){var p=document.getElementById(a.ID+"page-"+d);if(v(d)){var n=a.imageDir+"/",w=k(d,"r"),Z=k(d,"c"),l=!0,q=0,m=e-(w-1)*a.tileHeight,F=c-(Z-1)*a.tileWidth,B,s,W,fa,ga,M;baseImageURL=a.iipServerURL+"?FIF="+n+b+"&JTL="+(a.zoomLevel+a.pages[d].m-a.realMaxZoom)+",";for(n=0;n<w;){B=0;for(s=n===w-1?m:a.tileHeight;B<Z;){fa=n*a.tileHeight;
ga=B*a.tileWidth;W=B===Z-1?F:a.tileWidth;M=baseImageURL+q;if(!document.getElementById(a.ID+"tile-"+d+"-"+q)){var t=void 0,X=void 0;a.verticallyOriented?(t=a.pageTopOffsets[d]+n*a.tileHeight+a.verticalPadding,X=a.pageLeftOffsets[d]+B*a.tileWidth):(t=a.pageTopOffsets[d]+n*a.tileHeight,X=a.pageLeftOffsets[d]+B*a.tileWidth+a.horizontalPadding);var ra=X+a.tileWidth;r(t,t+a.tileHeight)&&u(X,ra)?(t=document.createElement("div"),t.id=a.ID+"tile-"+d+"-"+q,t.classList.add("diva-document-tile"),t.style.display=
"inline",t.style.position="absolute",t.style.top=fa+"px",t.style.left=ga+"px",t.style.backgroundImage="url('"+M+"')",t.style.height=s+"px",t.style.width=W+"px",p.appendChild(t)):l=!1}q++;B++}n++}a.allTilesLoaded[d]=l;g(a.onPageLoaded,d,b,T);diva.Events.publish("PageDidLoad",[d,b,T],f)}},a.pageLoadTimeout,d))}},S=function(d){d=document.getElementById(a.ID+"page-"+d);if(null!==d){for(;d.firstChild;)d.removeChild(d.firstChild);d.parentNode.removeChild(d)}},J=function(d){if(a.verticallyOriented){d=a.pageTopOffsets[d]+
k(d,"h")+a.verticalPadding;var b=document.getElementById(a.ID+"outer").scrollTop}else d=a.pageLeftOffsets[d]+k(d,"w")+a.horizontalPadding,b=document.getElementById(a.ID+"outer").scrollLeft;return d=d<b},x=function(d){if(a.verticallyOriented){d=a.pageTopOffsets[d];var b=document.getElementById(a.ID+"outer").scrollTop+a.panelHeight}else d=a.pageLeftOffsets[d],b=document.getElementById(a.ID+"outer").scrollLeft+a.panelWidth;return d=d>b},y=function(d,b){0<b?q(d)&&(s(d)?(m(d),a.lastPageLoaded=d,y(a.lastPageLoaded+
1,b)):J(d)&&y(d+1,b)):q(d)&&(s(d)?(m(d),a.firstPageLoaded=d,y(a.firstPageLoaded-1,b)):x(d)&&y(d-1,b))},z=function(d,b){0<b?q(d)&&J(d)&&(S(d),a.firstPageLoaded=d+1,z(a.firstPageLoaded,b)):q(d)&&x(d)&&(S(d),a.lastPageLoaded=d-1,z(a.lastPageLoaded,b))},A=function(d){return 0<=d&&d<a.numRows},I=function(d){d*=a.rowHeight;return r(d,d+a.rowHeight+a.fixedPadding)},G=function(d){if(!document.getElementById(a.ID+"row-"+d)){var b=a.rowHeight*d+a.fixedPadding,c=document.getElementById(a.ID+"inner"),e=document.createElement("div");
e.id=a.ID+"row-"+d;e.classList.add("diva-row");e.style.height=a.rowHeight+"px";e.style.top=b+"px";c.appendChild(e);for(var g,p,n,w,l,m,F=a.imageDir+"/",B=a.pagesPerRow,c=0;c<B;c++){g=d*a.pagesPerRow+c;if(!q(g))break;p=a.pages[g].f;n=k(g,"w");w=k(g,"h");l=a.fixedHeightGrid?(a.rowHeight-a.fixedPadding)*n/w:a.gridPageWidth;n=a.fixedHeightGrid?a.rowHeight-a.fixedPadding:l/n*w;w=parseInt(c*(a.fixedPadding+a.gridPageWidth)+a.fixedPadding,10);l=parseInt(l,10);n=parseInt(n,10);w+=a.fixedHeightGrid?(a.gridPageWidth-
l)/2:0;m=encodeURI(a.iipServerURL+"?FIF="+F+p+"&HEI="+(n+2)+"&CVT=JPEG");a.pageTopOffsets[g]=b;a.pageLeftOffsets[g]=w;var t=document.createElement("div");t.id=a.ID+"page-"+g;var s=a.selector+"page-"+g;t.classList.add("diva-page");t.style.width=l+"px";t.style.height=n+"px";t.style.left=w+"px";t.setAttribute("data-index",g);t.setAttribute("data-filename",p);a.enableImageTitles&&(t.title="Image "+(g+1));e.appendChild(t);diva.Events.publish("PageWillLoad",[g,p,s],f);W(d,g,m,l,n)}}},K=function(d){d=document.getElementById(a.ID+
"row-"+d);if(null!==d){for(;d.firstChild;)d.removeChild(d.firstChild);d.parentNode.removeChild(d)}},p=function(d){d=a.rowHeight*(d+1);var b=document.getElementById(a.ID+"outer").scrollTop;return d<b},w=function(d){d*=a.rowHeight;var b=document.getElementById(a.ID+"outer").scrollTop+a.panelHeight;return d>b},F=function(d,b){0<b?A(d)&&(I(d)?(G(d),a.lastRowLoaded=d,F(a.lastRowLoaded+1,b)):p(d)&&F(d+1,b)):A(d)&&(I(d)?(G(d),a.firstRowLoaded=d,F(a.firstRowLoaded-1,b)):w(d)&&F(d-1,b))},n=function(d,b){0<
b?A(d)&&p(d)&&(K(d),a.firstRowLoaded++,n(a.firstRowLoaded,b)):A(d)&&w(d)&&(K(d),a.lastRowLoaded--,n(a.lastRowLoaded,b))},W=function(d,b,c,e,f){a.pageTimeouts.push(window.setTimeout(function(d,b,c,e,f){document.getElementById(a.ID+"row-"+d)&&(d=document.createElement("img"),d.src=c,d.style.width=e+"px",d.style.height=f+"px",document.getElementById(a.ID+"page-"+b).appendChild(d))},a.rowLoadTimeout,d,b,c,e,f))},M=function(d){var b=a.currentPageIndex,c=b+d;if(!q(c))return!1;var e=a.verticallyOriented?
document.getElementById(a.ID+"outer").scrollTop+a.panelHeight/2:document.getElementById(a.ID+"outer").scrollLeft+a.panelWidth/2,p=!1;0>d?a.verticallyOriented?0<=c&&a.pageTopOffsets[c]+k(c,"h")+a.verticalPadding>=e&&(p=!0):0<=c&&a.pageLeftOffsets[c]+k(c,"w")+a.horizontalPadding>=e&&(p=!0):0<d&&(a.verticallyOriented?a.pageTopOffsets[b]+k(b,"h")+a.verticalPadding<e&&(p=!0):a.pageLeftOffsets[b]+k(b,"w")+a.horizontalPadding<e&&(p=!0));return p?(a.currentPageIndex=c,0===d||M(d)||(d=a.pages[c].f,g(a.onSetCurrentPage,
c,d),diva.Events.publish("VisiblePageDidChange",[c,d],f)),!0):!1},N=function(d){var b=Math.floor(a.currentPageIndex/a.pagesPerRow),c=b+parseInt(d,10),e=document.getElementById(a.ID+"outer").scrollTop,g=e+a.panelHeight/2,p=!1;0>d?0<=c&&(a.rowHeight*b>=g||a.rowHeight*c>=e)&&(p=!0):0<d&&a.rowHeight*(b+1)<e&&A(c)&&(p=!0);return p?(a.currentPageIndex=c*a.pagesPerRow,0===d||N(d)||(d=a.currentPageIndex,diva.Events.publish("VisiblePageDidChange",[d,a.pages[d].f],f)),!0):!1},H=function(d,b,c){c="undefined"!==
typeof c?c:0;b=a.pageTopOffsets[d]+("undefined"!==typeof b?b:0)-parseInt(a.panelHeight/2,10);c=a.pageLeftOffsets[d]+c-parseInt(a.panelWidth/2,10);a.outerObject.scrollTop(b);a.outerObject.scrollLeft(c);d!==a.currentPageIndex&&(a.currentPageIndex=d,c=a.pages[d].f,g(a.onSetCurrentPage,d,c),diva.Events.publish("VisiblePageDidChange",[d,c],f));g(a.onJump,d);diva.Events.publish("ViewerDidJump",[d],f)},B=function(d){a.outerObject.scrollTop(Math.floor(d/a.pagesPerRow)*a.rowHeight);a.currentPageIndex=d;diva.Events.publish("VisiblePageDidChange",
[d,a.pages[d].f],f)},t=function(d){return d>=a.minZoomLevel&&d<=a.maxZoomLevel?d:a.minZoomLevel},ha=function(d){return d>=a.minPagesPerRow&&d<=a.maxPagesPerRow?d:a.maxPagesPerRow},ia=function(){a.allTilesLoaded=[];a.outerObject.scrollTop(0);a.innerObject.empty();a.firstPageLoaded=0;a.firstRowLoaded=-1;a.previousTopScroll=0;a.previousLeftScroll=0;for(clearTimeout(a.resizeTimer);a.pageTimeouts.length;)clearTimeout(a.pageTimeouts.pop())},O=function(){a.inGrid?ja():aa()},aa=function(){ia();a.zoomLevel=
t(a.zoomLevel);var d=a.zoomLevel;a.totalHeight=a.totalHeights[d]+a.verticalPadding*(a.numPages+1);a.totalWidth=a.totalWidths[d]+a.horizontalPadding*(a.numPages+1);var b=a.maxHeights[d]+2*a.verticalPadding,c=Math.max(a.maxWidths[d]+2*a.horizontalPadding,a.panelWidth),b=Math.max(b,a.panelHeight),e=document.getElementById(a.ID+"inner");a.verticallyOriented?(e.style.height=Math.round(a.totalHeight)+"px",e.style.width=Math.round(c)+"px"):(e.style.height=Math.round(b)+"px",e.style.width=Math.round(a.totalWidth)+
"px");var p=0,n=0;a.pageTopOffsets=[];a.pageLeftOffsets=[];for(e=0;e<a.numPages;e++)a.pageTopOffsets[e]=parseInt(a.verticallyOriented?p:(b-k(e,"h"))/2,10),a.pageLeftOffsets[e]=parseInt(a.verticallyOriented?(c-k(e,"w"))/2:n,10),p=a.pageTopOffsets[e]+k(e,"h")+a.verticalPadding,n=a.pageLeftOffsets[e]+k(e,"w")+a.horizontalPadding;q(a.goDirectlyTo)||(a.goDirectlyTo=0);H(a.goDirectlyTo,a.verticalOffset,a.horizontalOffset);c=!1;for(e=0;e<a.numPages;e++)if(s(e))m(e),a.lastPageLoaded=e,c=!0;else if(c)break;
0<=a.oldZoomLevel?(a.oldZoomLevel<a.zoomLevel?(g(a.onZoomIn,d),diva.Events.publish("ViewerDidZoomIn",[d],f)):(g(a.onZoomOut,d),diva.Events.publish("ViewerDidZoomOut",[d],f)),g(a.onZoom,d)):a.oldZoomLevel=a.zoomLevel;a.scaleWait&&(a.scaleWait=!1);d=a.pages[a.currentPageIndex].f;g(a.onDocumentLoaded,a.currentPageIndex,d);diva.Events.publish("DocumentDidLoad",[a.currentPageIndex,d],f)},ja=function(){var d=a.currentPageIndex;a.verticalOffset=a.verticallyOriented?a.panelHeight/2:k(d,"h")/2;a.horizontalOffset=
a.verticallyOriented?k(d,"w")/2:a.panelWidth/2;ia();a.pagesPerRow=ha(a.pagesPerRow);d=(a.panelWidth-a.fixedPadding*(a.pagesPerRow+1))/a.pagesPerRow;a.gridPageWidth=d;a.rowHeight=a.fixedHeightGrid?a.fixedPadding+a.minRatio*d:a.fixedPadding+a.maxRatio*d;a.numRows=Math.ceil(a.numPages/a.pagesPerRow);a.totalHeight=a.numRows*a.rowHeight+a.fixedPadding;d=document.getElementById(a.ID+"inner");d.style.height=Math.round(a.totalHeight)+"px";d.style.width=Math.round(a.panelWidth)+"px";B(a.goDirectlyTo);var b;
a.pageTopOffsets=[];a.pageLeftOffsets=[];for(var c=a.numPages,d=0;d<c;d+=a.pagesPerRow)b=Math.floor(d/a.pagesPerRow),I(b)&&(a.firstRowLoaded=0>a.firstRowLoaded?b:a.firstRowLoaded,G(b),a.lastRowLoaded=b)},ka=function(a){27==a.keyCode&&C()},ba=function(d){a.outerObject.toggleClass("diva-fullscreen");b("body").toggleClass("diva-hide-scrollbar");a.parentObject.toggleClass("diva-full-width");if(a.mobileWebkit){var c=parseInt(a.outerObject.css("margin-left"),10)-parseInt(b("body").css("margin-left"),10);
a.outerObject.css("margin-left",c)}var c=a.panelHeight,e=a.panelWidth;P();if(0<=a.oldZoomLevel&&!a.inGrid){var p=a.panelHeight,n=a.panelWidth;a.inFullscreen?(a.verticalOffset-=(p-c)/2,a.horizontalOffset-=(n-e)/2):(a.verticalOffset+=(c-p)/2,a.horizontalOffset+=(e-n)/2)}d?(a.inGrid=!a.inGrid,D()):O();if(a.inFullscreen)b(document).on("keyup",ka);else b(document).off("keyup",ka);g(a.onModeToggle,a.inFullscreen);diva.Events.publish("ModeDidSwitch",[a.inFullscreen],f)},D=function(){O();g(a.onViewToggle,
...
ha(d);if(b!==d)return!1;a.pagesPerRow=b;diva.Events.publish("GridRowNumberDidChange",[b],f);a.goDirectlyTo=a.currentPageIndex;ja();return!0},Q=function(d,b){d="undefined"===typeof d?a.currentPageIndex:d;return"center"===b||"centre"===b?parseInt(k(d,"h")/2,10):"bottom"===b?parseInt(k(d,"h")-a.panelHeight/2,10):parseInt(a.panelHeight/2,10)},R=function(d,b){d="undefined"===typeof d?a.currentPageIndex:d;return"left"===b?parseInt(a.panelWidth/2,10):"right"===b?parseInt(k(d,"w")-a.panelWidth/2,10):parseInt(k(d,
"w")/2,10)},U=function(){return document.getElementById(a.ID+"outer").scrollTop-a.pageTopOffsets[a.currentPageIndex]+parseInt(a.panelHeight/2,10)},V=function(){return document.getElementById(a.ID+"outer").scrollLeft-a.pageLeftOffsets[a.currentPageIndex]+parseInt(a.panelWidth/2,10)},ma=function(){return{f:a.inFullscreen,g:a.inGrid,z:a.zoomLevel,n:a.pagesPerRow,i:a.enableFilename?a.pages[a.currentPageIndex].f:!1,p:a.enableFilename?!1:a.currentPageIndex+1,y:a.inGrid?!1:U(),x:a.inGrid?!1:V()}},na=function(){var d=
ma(),b=[],c;for(c in d)!1!==d[c]&&b.push(c+a.hashParamSuffix+"="+d[c]);return b.join("&")},oa=function(){return location.protocol+"//"+location.host+location.pathname+"#"+na()},P=function(){var d=document.getElementById(a.ID+"outer");a.panelHeight=d.clientHeight-(d.scrollWidth>d.clientWidth?a.scrollbarWidth:0);a.panelWidth=d.clientWidth-(d.scrollHeight>d.clientHeight?a.scrollbarWidth:0);a.horizontalOffset=V();a.verticalOffset=U();H(a.currentPageIndex,a.verticalOffset,a.horizontalOffset);return!0},
pa=function(){a.mobileWebkit||(a.outerObject.dragscrollable({dragSelector:".diva-dragger",acceptPropagatedEvent:!0}),a.innerObject.dragscrollable({dragSelector:".diva-dragger",acceptPropagatedEvent:!0}));a.outerObject.on("dblclick",".diva-document-page",function(a){ca.call(this,a)});a.outerObject.on("contextmenu",".diva-document-page",function(d){if(d.ctrlKey)return clearTimeout(a.singleClickTimeout),a.singleClick?(ca.call(this,d),a.singleClick=!1):(a.singleClick=!0,a.singleClickTimeout=setTimeout(function(){a.singleClick=
...
pa();a.outerObject.scroll(function(){var b,d=document.getElementById(a.ID+"outer").scrollTop,c=document.getElementById(a.ID+"outer").scrollLeft;b=a.verticallyOriented||a.inGrid?d-a.previousTopScroll:c-a.previousLeftScroll;if(a.inGrid){0>b?(F(a.firstRowLoaded,-1),N(-1),n(a.lastRowLoaded,-1)):0<b&&(F(a.lastRowLoaded,1),N(1),n(a.firstRowLoaded,1));var e=document.getElementById(a.ID+"outer").scrollTop}else{if(0>b)y(a.firstPageLoaded,b),M(-1),z(a.lastPageLoaded,b);else if(0<b)y(a.lastPageLoaded,b),M(1),
z(a.firstPageLoaded,b);else for(var p=a.lastPageLoaded,e=Math.max(a.firstPageLoaded,0);e<=p;e++)s(e)&&m(e);e=a.verticallyOriented?document.getElementById(a.ID+"outer").scrollTop:document.getElementById(a.ID+"outer").scrollLeft}g(a.onScroll,e);diva.Events.publish("ViewerDidScroll",[e],f);0<b?(g(a.onScrollDown,e),diva.Events.publish("ViewerDidScrollDown",[e],f)):0>b&&(g(a.onScrollUp,e),diva.Events.publish("ViewerDidScrollUp",[e],f));a.previousTopScroll=d;a.previousLeftScroll=c;a.horizontalOffset=V();
...
"outer").scrollTop-a.arrowScrollAmount),!1;case 40:return a.outerObject.scrollTop(document.getElementById(a.ID+"outer").scrollTop+a.arrowScrollAmount),!1;case 37:return a.outerObject.scrollLeft(document.getElementById(a.ID+"outer").scrollLeft-a.arrowScrollAmount),!1;case 39:return a.outerObject.scrollLeft(document.getElementById(a.ID+"outer").scrollLeft+a.arrowScrollAmount),!1;case 36:return a.outerObject.scrollTop(0),!1;case 35:return a.outerObject.scrollTop(a.totalHeight),!1}return!0});if(a.mobileWebkit){var d=
[];d.push('<meta name="viewport" content="user-scalable=no, width=device-width, initial-scale=1, maximum-scale=1" />');d.push('<meta name="apple-mobile-web-app-capable" content="yes" />');d.push('<meta name="apple-mobile-web-app-status-bar-style" content="black" />');b("head").append(d.join("\n"));a.blockMobileMove&&b("body").bind("touchmove",function(a){a.originalEvent.preventDefault();return!1});a.outerObject.kinetic({triggerHardware:!0});var c=[],e=[],p=0;a.outerObject.on("touchstart",".diva-document-page",
function(a){2===a.originalEvent.touches.length&&(c=[a.originalEvent.touches[0].clientX,a.originalEvent.touches[0].clientY,a.originalEvent.touches[1].clientX,a.originalEvent.touches[1].clientY],p=da(c[2],c[0],c[3],c[1]))});a.outerObject.on("touchmove",".diva-document-page",function(d){if(2===d.originalEvent.touches.length){e=[d.originalEvent.touches[0].clientX,d.originalEvent.touches[0].clientY,d.originalEvent.touches[1].clientX,d.originalEvent.touches[1].clientY];var c=da(e[2],e[0],e[3],e[1])-p;if(!a.scaleWait)if(a.goDirectlyTo=
a.currentPageIndex,a.inGrid)a.inGrid=!1,D();else a:{var f=a.zoomLevel;if(100<c&&f<a.maxZoomLevel)f++;else if(-100>c&&f>a.minZoomLevel)f--;else break a;a.scaleWait=!0;c=b(this).offset();a.horizontalOffset=d.pageX-c.left;a.verticalOffset=d.pageY-c.top;a.goDirectlyTo=parseInt(b(this).attr("data-index"),10);L(f)}}});var w={},l=0,d=function(d){if(a.singleTap){var c={pageX:d.originalEvent.changedTouches[0].clientX,pageY:d.originalEvent.changedTouches[0].clientY};l=da(w.pageX,c.pageX,w.pageY,c.pageY);50>
l&&a.zoomLevel<a.maxZoomLevel&&(a.inGrid?la.call(b(d.target).parent(),c):ca.call(this,c));a.singleTap=!1;w={}}else a.singleTap=!0,w.pageX=d.originalEvent.changedTouches[0].clientX,w.pageY=d.originalEvent.changedTouches[0].clientY,a.singleTapTimeout=setTimeout(function(){a.singleTap=!1;w={}},250)};a.outerObject.on("touchend",".diva-document-page",d);a.outerObject.on("touchend",".diva-page",d);d="onorientationchange"in window?"orientationchange":"resize";b(window).bind(d,function(b){b=a.panelWidth;
var d=a.panelHeight;P();a.horizontalOffset-=(a.panelWidth-b)/2;a.verticalOffset-=(a.panelHeight-d)/2;a.goDirectlyTo=a.currentPageIndex;O()})}else b(window).resize(function(){P();clearTimeout(a.resizeTimer);a.resizeTimer=setTimeout(function(){a.goDirectlyTo=a.currentPageIndex;a.verticalOffset=U();a.horizontalOffset=V();O()},200)});diva.Events.subscribe("PanelSizeDidChange",P)},ta=function(){a.toolbarParentObject.prepend('<div id="'+a.ID+'tools" class="diva-tools">'+('<div id="'+a.ID+'tools-left" class="diva-tools-left">'+
...
'<div id="'+a.ID+'zoom-buttons-label" class="diva-buttons-label">Zoom level: <span id="'+a.ID+'zoom-level">'+a.zoomLevel+"</span></div>":"")+("slider"===a.enableGridControls?'<div id="'+a.ID+'grid-slider-label" class="diva-slider-label">Images per row: <span id="'+a.ID+'pages-per-row">'+a.pagesPerRow+"</span></div>":"")+("buttons"===a.enableGridControls?'<div id="'+a.ID+'grid-buttons-label" class="diva-buttons-label">Images per row: <span id="'+a.ID+'pages-per-row">'+a.pagesPerRow+"</span></div>":"")+
...
"")+'<div id="'+a.ID+'page-nav" class="diva-page-nav">'+(a.enableGotoPage?'<form id="'+a.ID+'goto-page" class="diva-goto-form"><input type="text" id="'+a.ID+'goto-page-input" / class="diva-input"> <input type="submit" value="Go" style="margin-top: 0px;" /></form>':"")+('<div class="diva-page-label">Image <span id="'+a.ID+'current-page">1</span> of <span id="'+a.ID+'num-pages">'+a.numPages+"</span></div>")+"</div></div>")+"</div>");b(a.selector+"zoom-slider").on("input",function(a){a=parseInt(this.value,
10);L(a)});b(a.selector+"zoom-slider").on("change",function(b){b=parseInt(this.value,10);b!==a.zoomLevel&&L(b)});b(a.selector+"zoom-out-button").click(function(){L(a.zoomLevel+-1)});b(a.selector+"zoom-in-button").click(function(){L(a.zoomLevel+1)});b(a.selector+"grid-slider").on("input",function(a){a=parseInt(this.value,10);Y(a)});b(a.selector+"grid-slider").on("change",function(b){b=parseInt(this.value,10);b!==a.zoomLevel&&Y(b)});b(a.selector+"fullscreen").click(function(){C()});b(a.selector+"grid-out-button").click(function(){Y(a.pagesPerRow-
...
return!1});var c=a.inGrid?"grid":"zoom";b(a.selector+c+"-slider").show();b(a.selector+c+"-out-button").show();b(a.selector+c+"-in-button").show();b(a.selector+c+"-slider-label").show();b(a.selector+c+"-buttons-label").show();return{updateCurrentPage:function(){document.getElementById(a.ID+"current-page").textContent=a.currentPageIndex+1},setNumPages:function(b){document.getElementById(a.ID+"num-pages").textContent=b},updateZoomSlider:function(){a.zoomLevel!==b(a.selector+"zoom-slider").val()&&b(a.selector+
...
"none")},switchView:function(){b(a.selector+c+"-slider").hide();b(a.selector+c+"-out-button").hide();b(a.selector+c+"-in-button").hide();b(a.selector+c+"-slider-label").hide();b(a.selector+c+"-buttons-label").hide();c=a.inGrid?"grid":"zoom";b(a.selector+c+"-slider").show();b(a.selector+c+"-out-button").show();b(a.selector+c+"-in-button").show();b(a.selector+c+"-slider-label").show();b(a.selector+c+"-buttons-label").show();b(a.selector+"grid-icon").toggleClass("diva-in-grid")},switchMode:function(){b(a.selector+
"tools").toggleClass("diva-fullscreen-tools");a.inFullscreen?b(a.selector+"tools-left").addClass("in-fullscreen"):b(a.selector+"tools-left").removeClass("in-fullscreen")}}},ua=function(){if(window.divaPlugins){var d=[];b.each(window.divaPlugins,function(b,c){var e=c.pluginName[0].toUpperCase()+c.pluginName.substring(1);a["enable"+e]&&c.init(a,f)&&(e=c.titleText||e+" plugin","function"===typeof c.handleClick&&(d.push('<div class="diva-'+c.pluginName+'-icon" title="'+e+'"></div>'),a.outerObject.on(a.mobileWebkit?
"touchend":"click",".diva-"+c.pluginName+"-icon",function(b){c.handleClick.call(this,b,a,f)})),a.plugins.push(c))});d.length&&(a.pageTools='<div class="diva-page-tools">'+d.join("")+"</div>")}},qa=function(){clearTimeout(a.throbberTimeoutID);b(a.selector+"throbber").hide()},va=function(){a.outerObject.append('<div id="'+a.ID+'throbber" class="diva-throbber"></div>');a.throbberTimeoutID=setTimeout(function(){b(a.selector+"throbber").show()},a.throbberTimeout);b.ajax({url:a.objectData,cache:!0,dataType:"json",
error:function(b,c,e){qa();b='<div id="'+a.ID+'error" class="diva-error"><p><strong>Error</strong></p><p>Invalid objectData. Error code: '+c+" "+e+"</p>";0===a.objectData.lastIndexOf("http",0)&&""===e&&(e=a.objectData.replace(/https?:\/\//i,"").split(/[/?#]/)[0],location.hostname!==e&&(b+='<p>Attempted to access cross-origin data without CORS.</p><p>You may need to update your server configuration to support CORS. For help, see the <a href="https://github.com/DDMAL/diva.js/wiki/Installation#a-note-about-cross-site-requests" target="_blank">cross-site request documentation.</a></p>'));
a.outerObject.append(b+"</div>")},success:function(d,c,e){qa();a.pages=d.pgs;a.maxRatio=d.dims.max_ratio;a.minRatio=d.dims.min_ratio;a.itemTitle=d.item_title;a.numPages=d.pgs.length;a.maxWidths=d.dims.max_w;a.maxHeights=d.dims.max_h;a.averageWidths=d.dims.a_wid;a.averageHeights=d.dims.a_hei;a.totalHeights=d.dims.t_hei;a.totalWidths=d.dims.t_wid;a.realMaxZoom=d.max_zoom;a.maxZoomLevel=0<=a.maxZoomLevel&&a.maxZoomLevel<=d.max_zoom?a.maxZoomLevel:d.max_zoom;a.minZoomLevel=0<=a.minZoomLevel&&a.minZoomLevel<=
a.maxZoomLevel?a.minZoomLevel:0;a.zoomLevel=t(a.zoomLevel);a.minPagesPerRow=Math.max(2,a.minPagesPerRow);a.maxPagesPerRow=Math.max(a.minPagesPerRow,a.maxPagesPerRow);a.enableFilename?(d=b.getHashParam("i"+a.hashParamSuffix),d=l(d)):d=parseInt(b.getHashParam("p"+a.hashParamSuffix),10)-1;q(d)&&(a.goDirectlyTo=d,a.currentPageIndex=d);b.each(a.plugins,function(b,d){g(d.setupHook,a)});a.enableToolbar&&(a.toolbar=ta(),diva.Events.subscribe("VisiblePageDidChange",a.toolbar.updateCurrentPage),diva.Events.subscribe("ModeDidSwitch",
...
a.itemTitle+"</div>");a.parentObject.parent()[0]!==document.body||a.parentObject.siblings().not("#diva-canvas-backdrop")[0]||(a.divaIsFullWindow=!0);P();q(parseInt(a.goDirectlyTo),10)||(a.goDirectlyTo=0);0<a.adaptivePadding?(d=a.zoomLevel,a.horizontalPadding=parseInt(a.averageWidths[d]*a.adaptivePadding,10),a.verticalPadding=parseInt(a.averageHeights[d]*a.adaptivePadding,10)):(a.horizontalPadding=a.fixedPadding,a.verticalPadding=a.fixedPadding);a.pageTools.length&&(a.verticalPadding=Math.max(40,a.verticalPadding));
d=parseInt(b.getHashParam("y"+a.hashParamSuffix),10);isNaN(d)?a.verticalOffset=Q(a.currentPageIndex,"top"):a.verticalOffset=d;d=parseInt(b.getHashParam("x"+a.hashParamSuffix),10);isNaN(d)?a.horizontalOffset=R(a.currentPageIndex,"center"):a.horizontalOffset=d;a.inFullscreen?ba(!1):O();P();g(a.onReady,a);diva.Events.publish("ViewerDidLoad",[a],f);a.loaded=!0}})},ea=function(){return a.loaded?!0:(console.warn("The viewer is not completely initialized. This is likely because it is still downloading data. To fix this, only call this function if the isReady() method returns true."),
...
d<=a.maxPagesPerRow&&(a.pagesPerRow=d);d=b.getHashParam("z"+a.hashParamSuffix);""!==d&&(d=parseInt(d,10),d>=a.minZoomLevel&&(a.zoomLevel=d));var d=b.getHashParam("g"+a.hashParamSuffix),c="true"===d,e=b.getHashParam("f"+a.hashParamSuffix);a.inGrid=a.inGrid&&"false"!==d||c;a.inFullscreen=a.inFullscreen&&"false"!==e||"true"===e;va();ua();sa()})();this.getItemTitle=function(){return a.itemTitle};this.gotoPageByNumber=function(a,b,c){a-=1;return q(a)?(H(a,Q(a,c),R(a,b)),!0):!1};this.gotoPageByIndex=function(a,
b,c){return q(a)?(H(a,Q(a,c),R(a,b)),!0):!1};this.getCurrentPage=function(){console.warn("The call to getCurrentPage is deprecated. Use getCurrentPageIndex instead.");return a.currentPageIndex};this.getNumberOfPages=function(){return ea()?a.numPages:!1};this.getPageDimensionsAtZoomLevel=function(b,c){if(!ea())return!1;c>a.maxZoomLevel&&(c=a.maxZoomLevel);var e=a.pages[b].d[parseInt(c,10)];return{width:e.w,height:e.h}};this.getCurrentPageDimensionsAtCurrentZoomLevel=function(){return this.getPageDimensionsAtZoomLevel(a.currentPageIndex,
...
a.pages[b].m:!1};this.getMinZoomLevel=function(){return a.minZoomLevel};this.setZoomLevel=function(b){a.inGrid&&E();return L(b)};this.zoomIn=function(){return this.setZoomLevel(a.zoomLevel+1)};this.zoomOut=function(){return this.setZoomLevel(a.zoomLevel-1)};this.inViewport=function(b,c,e,f,p){b-=1;e=a.pageTopOffsets[b]+e;c=a.pageLeftOffsets[b]+c;f=c+f;return r(e,e+p)&&u(c,f)};this.isPageInViewport=function(a){return s(a)};this.isPageInDOM=function(a){return v(a)};this.toggleFullscreenMode=function(){C()};
this.closePopups=function(){a.toolbar.closePopups()};this.enterFullscreenMode=function(){return a.inFullscreen?!1:(C(),!0)};this.leaveFullscreenMode=function(){return a.inFullscreen?(C(),!0):!1};this.toggleGridView=function(){E()};this.enterGridView=function(){return a.inGrid?!1:(E(),!0)};this.leaveGridView=function(){return a.inGrid?(E(),!0):!1};this.gotoPageByName=function(a,b,c){a=l(a);return q(a)?(H(a,Q(a,c),R(a,b)),!0):!1};this.getPageIndex=function(a){return l(a)};this.getCurrentURL=function(){return oa()};
this.getURLHash=function(){return na()};this.getState=function(){return ma()};this.getInstanceSelector=function(){return a.selector};this.getInstanceId=function(){return a.ID};this.getSettings=function(){return a};this.translateFromMaxZoomLevel=function(b){return b/Math.pow(2,a.maxZoomLevel-a.zoomLevel)};this.translateToMaxZoomLevel=function(b){var c=a.maxZoomLevel-a.zoomLevel;return 0===c?b:b*Math.pow(2,c)};this.setState=function(b){var c;c=l(b.i);q(c)?a.goDirectlyTo=c:q(b.p)&&(a.goDirectlyTo=b.p);
horizontalOffset=parseInt(b.x,10);verticalOffset=parseInt(b.y,10);b.z>=a.minZoomLevel&&b.z<=a.maxZoomLevel&&(a.zoomLevel=b.z);b.n>=a.minPagesPerRow&&b.n<=a.maxPagesPerRow&&(a.pagesPerRow=b.n);a.inFullscreen!==b.f?(a.inFullscreen=b.f,ba(a.inGrid!==b.g),a.horizontalOffset=horizontalOffset,a.verticalOffset=verticalOffset,H(c,a.verticalOffset,a.horizontalOffset)):(a.horizontalOffset=horizontalOffset,a.verticalOffset=verticalOffset,a.inGrid!==b.g?(a.inGrid=b.g,D()):O())};this.enableScrollable=function(){a.isScrollable||
...
180);e.drawImage(a,g,h,b.width,b.height);e.restore();b.data=e.getImageData(0,0,b.size,b.size)},u=function(){for(var a in h)if(h[a].current!==h[a].previous)return!0;return!1},r=function(){l(e,h.rotation.current);v(e)},q=function(){var a=h.rotation.current,e=h.zoom.current,g=h.zoom.previous;if(a!==h.rotation.previous||e!==g){var n=b("#diva-canvas-wrapper").scrollLeft(),k=b("#diva-canvas-wrapper").scrollTop(),m=c.viewport.width/2,q=c.viewport.height/2,n=n+m-f.centerX,r=-(k+q-f.centerY),B=(h.rotation.previous-
a)*Math.PI/180,k=Math.cos(B)*n-Math.sin(B)*r+f.centerX,n=-(Math.sin(B)*n+Math.cos(B)*r)+f.centerY,e=Math.pow(2,e-g),m=e*k-m,q=e*n-q;l(f,a);b("#diva-canvas-wrapper").scrollLeft(m);b("#diva-canvas-wrapper").scrollTop(q)}if(u()){v(f);for(var t in h)h[t].previous=h[t].current}},s=function(a){var b=h[a].current!==h[a].initial;return h[a].current!==h[a].previous||b},v=function(a){var b=a.data,e=a.context.createImageData(b),f=e.data,g,k;g=0;for(k=f.length;g<k;g++)f[g]=b.data[g];b=e.data;g=h.contrast.current;
f=(1+Math.min(c.brightnessMax,Math.max(c.brightnessMin,h.brightness.current))/c.brightnessMax)*g;g=128-128*g;k=h.red.current;var l=h.green.current,m=h.blue.current,q=s("red"),t=s("green"),r=s("blue"),u=s("brightness"),v=s("contrast"),u=u||v,x,z,y,A,D,C,E,v=0;for(z=e.width;v<z;v++)for(x=0,y=e.height;x<y;x++)A=4*(x*z+v),D=b[A],C=b[A+1],E=b[A+2],0<D+C+E&&(q&&D&&(D+=k),t&&C&&(C+=l),r&&E&&(E+=m),u&&(D&&(D=D*f+g),C&&(C=C*f+g),E&&(E=E*f+g)),b[A]=D,b[A+1]=C,b[A+2]=E);a.context.clearRect(0,0,z,y);a.context.putImageData(e,
0,0)},m=function(){var a=b("#diva-canvas-wrapper").scrollLeft()*e.scaleFactor,f=b("#diva-canvas-wrapper").scrollTop()*e.scaleFactor,g=Math.min(Math.round(c.viewport.height*e.scaleFactor),c.mapSize)-4,h=Math.min(Math.round(c.viewport.width*e.scaleFactor),c.mapSize)-4;b("#diva-map-viewbox").height(g).width(h).css({top:f,left:a})},S=function(g,h){a=new Image;a.src=g;a.crossOrigin="Anonymous";a.onload=function(){f.size=Math.sqrt(a.width*a.width+a.height*a.height);f.canvas=document.getElementById("diva-canvas");
f.canvas.width=f.size;f.canvas.height=f.size;f.cornerX=(f.size-a.width)/2;f.cornerY=(f.size-a.height)/2;f.width=a.width;f.height=a.height;f.centerX=f.size/2;f.centerY=f.size/2;f.context=f.canvas.getContext("2d");f.context.drawImage(a,f.cornerX,f.cornerY,f.width,f.height);try{f.data=f.context.getImageData(0,0,f.size,f.size)}catch(g){var p='<div id="diva-error" class="diva-error"><p><strong>Error</strong></p><p>'+g.message+"</p>";if("SecurityError"!==g.name)throw g;p+='<p>You may need to update your server configuration in order to use the image manipulation tools. For help, see the <a href="https://github.com/DDMAL/diva.js/wiki/The-API-and-Plugins#a-note-about-canvas-and-cross-site-data" target="_blank">canvas cross-site data documentation</a>.</p></div></div>';
b("#diva-canvas-backdrop").append(p);A()}void 0===h&&(p=a,e.canvas=document.getElementById("diva-canvas-minimap"),e.size=c.mapSize,e.canvas.width=e.size,e.canvas.height=e.size,e.context=e.canvas.getContext("2d"),e.context.fillRect(0,0,e.size,e.size),e.scaleFactor=c.mapSize/f.size,e.cornerX=f.cornerX*e.scaleFactor,e.cornerY=f.cornerY*e.scaleFactor,e.width=p.width*e.scaleFactor,e.height=p.height*e.scaleFactor,e.context.drawImage(p,e.cornerX,e.cornerY,e.width,e.height),e.data=e.context.getImageData(0,
0,c.mapSize,c.mapSize),b("#diva-map-viewbox").show(),m());r();q(f);A();"function"===typeof h&&h.call(h)}},J=function(){var a=h[g],c=a.current,a=a.transform?a.transform(c):c;b("#diva-canvas-value").html(a)},x=function(){b("#diva-canvas-slider").val(h[g].current)},y=function(a){a=c.zoomWidthRatio*Math.pow(2,a);return c.proxyURL?c.proxyURL+"?f="+c.filename+"&w="+a:c.iipServerURL+"?FIF="+(c.imageDir+"/")+c.filename+"&WID="+a+"&CVT=JPEG"},z=function(){(0<h.zoom.current||c.mobileWebkit)&&b(c.selector+"throbber").addClass("canvas-throbber").show()},
A=function(){b(c.selector+"throbber").removeClass("canvas-throbber").hide()},I=function(){var a={},b=!1,e=c.localStoragePrefix+c.filename,f;for(f in h)h[f].previous!==h[f].initial&&(a[f]=h[f].previous,b=!0);b?(c.pluginIcon.addClass("new"),localStorage.setObject(e,a)):(c.pluginIcon.removeClass("new"),localStorage.removeItem(e))},G=function(a,b){c.zoomLevel=a;var g=y(a);S(g,function(){e.scaleFactor=e.size/f.size;m();I()})},K=function(a){switch(a.keyCode){case 38:return b("#diva-canvas-wrapper").scrollTop(document.getElementById("diva-canvas-wrapper").scrollTop-
c.arrowScrollAmount),!1;case 40:return b("#diva-canvas-wrapper").scrollTop(document.getElementById("diva-canvas-wrapper").scrollTop+c.arrowScrollAmount),!1;case 37:return b("#diva-canvas-wrapper").scrollLeft(document.getElementById("diva-canvas-wrapper").scrollLeft-c.arrowScrollAmount),!1;case 39:return b("#diva-canvas-wrapper").scrollLeft(document.getElementById("diva-canvas-wrapper").scrollLeft+c.arrowScrollAmount),!1}};return{init:function(a,l){if(!window.HTMLCanvasElement)return!1;b.extend(c,
k,a.canvasPlugin);c.inCanvas=!1;c.iipServerURL=a.iipServerURL;c.imageDir=a.imageDir;c.selector=a.selector;c.mobileWebkit=a.mobileWebkit;c.arrowScrollAmount=a.arrowScrollAmount;h={contrast:{initial:1,min:c.contrastMin,max:c.contrastMax,step:c.contrastStep,transform:function(a){return a.toFixed(2)},title:"Change the contrast"},brightness:{initial:0,min:c.brightnessMin,max:c.brightnessMax,step:c.brightnessStep,title:"Adjust the brightness"},rotation:{initial:0,min:0,max:359,step:1,transform:function(a){return a+
"&deg;"},title:"Rotate the image"},zoom:{initial:0,min:0,max:0,step:1,title:"Adjust the zoom level"},red:{initial:0,min:c.rgbMin,max:c.rgbMax,step:1,title:"Adjust the red channel"},green:{initial:0,min:c.rgbMin,max:c.rgbMax,step:1,title:"Adjust the green channel"},blue:{initial:0,min:c.rgbMin,max:c.rgbMax,step:1,title:"Adjust the blue channel"}};var v=function(){var a,b,c;for(c in h)b=h[c],a=b.initial,b.current=a,b.previous=a};v();if(b("#diva-canvas-backdrop").length)return!0;var n=[],s,y,N;for(N in c.buttons)s=
c.buttons[N],y=h[s].title,s='<div class="'+s+'" title="'+y+'"></div>',n.push(s);n='<div id="diva-canvas-backdrop">'+('<div id="diva-canvas-tools"><div id="diva-canvas-toolbar"><div id="diva-canvas-close" title="Return to the document viewer"></div><div id="diva-canvas-minimise" title="Minimise the toolbar"></div><span id="diva-canvas-info">Test</span></div><div id="diva-canvas-toolwindow"><div id="diva-map-viewbox"></div><canvas id="diva-canvas-minimap"></canvas><div id="diva-canvas-buttons">'+n.join("")+
'</div><div id="diva-canvas-pane"><p id="diva-canvas-tooltip"><span id="diva-canvas-mode">contrast</span>: <span id="diva-canvas-value">0</span> <span id="diva-canvas-reset" class="link">(Reset)</span></p><input type="range" id="diva-canvas-slider"></input></div><br /><div class="action-buttons"><a href="#" id="diva-canvas-reset-all">Reset all</a><a href="#" id="diva-canvas-apply">Apply</a></div></div></div>')+'<div id="diva-canvas-wrapper"><canvas id="diva-canvas"></canvas></div></div>';b("body").append(n);
c.mapSize=b("#diva-canvas-minimap").width();b("#diva-canvas-buttons div").click(function(){b("#diva-canvas-buttons .clicked").removeClass("clicked");H(b(this).attr("class"))});var H=function(a){g=a;a=h[g];b("#diva-canvas-buttons ."+g).addClass("clicked");b("#diva-canvas-mode").text(g);var c=a.current,e=a.transform?a.transform(c):c,f=document.getElementById("diva-canvas-slider");f.min=a.min;f.max=a.max;f.step=a.step;b("#diva-canvas-slider").val(c);b("#diva-canvas-value").html(e)};H("contrast");b("#diva-canvas-slider").on("input",
function(a){h[g].current=parseFloat(this.value);J();r()});b("#diva-canvas-reset-all").click(function(){for(var a in h)h[a].current=h[a].initial;J();x();r()});b("#diva-canvas-reset").click(function(){h[g].current=h[g].initial;J();x();r()});b("#diva-canvas-apply").click(function(){u()&&(z(),setTimeout(function(){h.zoom.current!==h.zoom.previous?G(h.zoom.current):(q(),A(),I())},c.throbberTimeout))});b("#diva-canvas-close").click(function(){b("body").removeClass("overflow-hidden");f.context.clearRect(0,
0,f.size,f.size);e.context.clearRect(0,0,e.size,e.size);b("#diva-canvas-wrapper").scrollTop(0).scrollLeft(0);b("#diva-canvas-backdrop").hide();b("#diva-map-viewbox").hide();A();l.enableScrollable();b(document).off("keydown",K);v();J();x();b("#diva-canvas-buttons .clicked").removeClass("clicked");H("contrast");diva.Events.publish("CanvasViewDidHide")});b("#diva-canvas-minimise").click(function(){b("#diva-canvas-toolwindow").slideToggle("fast")});b(window).resize(function(){c.viewport={height:window.innerHeight-
a.scrollbarWidth,width:window.innerWidth-a.scrollbarWidth};c.inCanvas&&m()});b("#diva-canvas-wrapper").scroll(function(){c.inCanvas&&m()});b("#diva-canvas-minimap, #diva-map-viewbox").mouseup(function(a){var f=b("#diva-canvas-minimap").offset(),g=(a.pageX-f.left)/e.scaleFactor;a=(a.pageY-f.top)/e.scaleFactor;b("#diva-canvas-wrapper").scrollTop(a-c.viewport.height/2);b("#diva-canvas-wrapper").scrollLeft(g-c.viewport.width/2)});b("#diva-canvas").mousedown(function(){b(this).addClass("grabbing")}).mouseup(function(){b(this).removeClass("grabbing")});
