...
a.horizontalPadding,T=a.selector+"page-"+d,l;if(!v(d)){var q=document.getElementById(a.ID+"inner"),n=document.createElement("div");n.id=a.ID+"page-"+d;n.classList.add("diva-document-page");n.setAttribute("data-index",d);n.setAttribute("data-filename",b);a.enableImageTitles&&(n.title="Page "+(d+1));n.innerHTML=a.pageTools;n.style.width=c+"px";n.style.height=e+"px";a.verticallyOriented?(n.style.top=p+"px",n.classList.add("diva-page-vertical")):(n.style.left=w+"px",n.classList.add("diva-page-horizontal"));
...
l)/2:0;m=encodeURI(a.iipServerURL+"?FIF="+F+p+"&HEI="+(n+2)+"&CVT=JPEG");a.pageTopOffsets[g]=b;a.pageLeftOffsets[g]=w;var t=document.createElement("div");t.id=a.ID+"page-"+g;var s=a.selector+"page-"+g;t.classList.add("diva-page");t.style.width=l+"px";t.style.height=n+"px";t.style.left=w+"px";t.setAttribute("data-index",g);t.setAttribute("data-filename",p);a.enableImageTitles&&(t.title="Page "+(g+1));e.appendChild(t);diva.Events.publish("PageWillLoad",[g,p,s],f);W(d,g,m,l,n)}}},K=function(d){d=document.getElementById(a.ID+
